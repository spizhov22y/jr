...
test("Test-10: Search and Navigate to J&R Custom Woodwork (Cross-Device) with Random Context", async ({
  browser,
}) => {
  // Log the test number at the start
  console.log("Running Test-10: Search and Navigate to J&R Custom Woodwork");
