...
test("Test-7: Google Search and Navigate to J&R Custom Woodwork", async ({
  page,
}) => {
  ...
  const searchQuery = "modern design kitchen kelowna";
  ...
  const found = await findAndClickLink(
    page,
    "J&R Custom Woodwork // Kelowna Custom Kitchen Cabinets #1"
  );
